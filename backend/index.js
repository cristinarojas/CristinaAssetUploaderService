...
const port = 3000; // The port where the app will be running 

// Aws Configuration object storage service
const s3 = new AWS.S3({ // Amazon Simple Storage Service (Amazon S3) 
...
app.post('/upload', upload, (req, res) => {
    ...
    const params = { // This object have information that the s3.upload need to be executed
